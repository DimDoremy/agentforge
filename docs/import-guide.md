...
ln -s /path/to/agentforge/skills/agentforge-workflow        ~/.zcode/skills/agentforge-workflow
```
...
1. Match `agentforge-workflow` at the start of harness work → scaffold from `template/`.
